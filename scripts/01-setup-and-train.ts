...
async function main() {
  ...
  try {
    ...
    const trainingResult = await Effect.runPromise(sqlGen.trainFromDatabase())
    ...
    console.log('==================')
    console.log(`✓ Database connection: ${sqlGenConfig.postgres.host}:${sqlGenConfig.postgres.port}/${sqlGenConfig.postgres.database}`)
